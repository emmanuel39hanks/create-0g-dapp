  ...
  return (
    <div className="min-h-screen flex flex-col max-w-3xl mx-auto">
      <div className="p-8 pb-4">
        ...
        <h1 className="text-2xl font-black mb-1"><span className="text-[#9200E1]">0G</span> Compute</h1>
        <p className="text-[#999] text-sm">Chat with an AI model running on 0G's decentralized compute network.</p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-8 space-y-4 pb-4">
        ...
        {loading && (
          <div className="flex justify-start">
            <div className="bg-[#F5F5F5] rounded-2xl px-4 py-3 text-sm text-[#666] animate-pulse">
      ...
      <div className="p-8 pt-4">
        <div className="flex gap-3">
          ...
          <button
            ...
            className="px-6 py-3 bg-[#9200E1] text-white text-sm font-bold rounded-full hover:bg-[#7A00BD] disabled:opacity-50 transition-colors"
          >
            Send
          </button>
        </div>
